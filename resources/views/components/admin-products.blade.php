<div
    ...
    <div class="bg-cover bg-center bg-no-repeat rounded-t-lg p-4 flex justify-end h-3/5 px-4 pt-4"
        ...
        <div id="dropdown--{{ $product->id }}"
            ...
            <ul class="py-2" aria-labelledby="dropdownButton--{{ $product->id }}">
                ...
                <li>
                    <a href="#"
                        class="block px-4 py-2 text-sm text-red-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-red-200 dark:hover:text-red">Eliminar</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="flex flex-col items-center h-2/5">
        ...
        <div class="flex mt-2">
            <button
                class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Publicar</button>
            <button data-modal-target="default-modal--{{ $product->id }}" data-modal-toggle="default-modal--{{ $product->id }}"
